...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().
                ...
                .antMatchers("/api/serv/**").permitAll()
                .antMatchers("/apic/**").permitAll()
                .antMatchers("/apiparametre/**").permitAll()
                .antMatchers("/apim/**").permitAll()
                .antMatchers("/app/**").permitAll()
                .antMatchers("/apipe/**").permitAll()
                .antMatchers("/apir/**").permitAll()
                .antMatchers("/apiu/**").permitAll()
                .antMatchers("/apipri/**").permitAll()
